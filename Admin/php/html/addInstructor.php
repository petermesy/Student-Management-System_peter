...
if (isset($_POST['submit'])) {
    ...
    if (!$conn) {
        ...
        $query = "INSERT INTO instructor (Full_name, email, phone, address, subject, degree_level) VALUES ('$full_name', '$email', '$phone', '$address', '$subject', '$degree_level')";

        if (mysqli_query($conn, $query)) {
           
            ?>
            <p class="notification">Instructor added successfully!</h3>
            <?php 
        }
        else {
             ?>
            <p class="notification" style="color: red;">Error adding Instructor!</h3>
...
?>
 <form method="POST">
    <div class="input1">
        ...
        <input type="text" name="full_name" placeholder="Instructor Full Name" class="inputt"><br><br>
        ...
        <input type="text" name="address" placeholder="Address" class="inputt"><br><br>
        <input type="text" name="subject" placeholder="Subject" class="inputt"><br><br>
        <input type="text" name="degree_level" placeholder="degree Level" class="inputt"><br><br>
        <input type="submit" value="Add Instructor" name="submit" class="bak"> <br>
...
<!-- <div class="mar"><marquee behavior="" direction="">current seesion</marquee></div> -->
</body>
 </html>
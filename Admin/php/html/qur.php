...
$session_name = ''; // Assuming you have a form field for session name
$start_date = ''; // Assuming you have a form field for session start date
$end_date = ''; // Assuming you have a form field for session end date

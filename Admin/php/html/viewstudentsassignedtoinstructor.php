...
$query="SELECT i.Full_name AS instructor_name, isn.Full_name AS student_name
        FROM instructor i
        JOIN instructor_student ii ON i.id=ii.id
        JOIN student isn ON ii.student_id=isn.student_id
        ORDER BY i.Full_name, isn.Full_name";
...
<body>
    <h1 class="info">Student Names assigned to All Instructors</h1>

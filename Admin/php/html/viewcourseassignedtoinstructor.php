...
$query="SELECT i.Full_name AS instructor_name, isn.Subject_name AS course_name
        FROM instructor i
        JOIN instructor_course_assignment ii ON i.id=ii.id
        JOIN subject isn ON ii.subject_id=isn.subject_id
        ORDER BY i.Full_name, isn.Subject_name";

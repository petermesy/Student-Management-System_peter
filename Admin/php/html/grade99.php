...
$result = $conn->query($sql);
 ...
 if ($result->num_rows > 0) {
   // Create or truncate the 'grade9' table
    $createTableSQL = "CREATE TABLE IF NOT EXISTS grade9 (
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $insertSQL = "INSERT INTO grade9 (student_id) VALUES ('$student_id')";
        if ($conn->query($insertSQL) === TRUE) {
            echo "Student ID '$student_id' inserted into 'grade9' table.<br>";
        } else {

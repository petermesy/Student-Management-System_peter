...
if (isset($_POST['update'])) {
    ...
    if (!empty($_POST['new_Gender'])) {
        $updates[] = "Gender='" . $_POST['new_Gender'] . "'";
    }

    // if (!empty($_POST['new_grade'])) {
    //     $updates[] = "grade='" . $_POST['new_grade'] . "'";
    // }

    if (!empty($_POST['mothername'])) {
        $updates[] = "mother_full_name='" . $_POST['mothername'] . "'";
    }


    if (!empty($_POST['new_Username'])) {
        $updates[] = "username='" . $_POST['new_Username'] . "'";
    }
    ...
    if (!empty($updates)) {
        $sql = "UPDATE student SET " . implode(", ", $updates) . " WHERE student_id=$id";
...
?>
<h1 class="info">Update Student information Records</h1> 
<form method="POST">
    <label for="id">Student ID:</label>
    <input type="number" name="id" class="inputt" required>
    <br><br>
    <label for="new_name">New Name:</label>
    <input type="text" name="new_name" class="inputt" >
    <br><br>
   <label for="mothername">New Mother Full level:</label> 
    <input type="text" name="mothername" class="inputt" >
    <br><br>
    ...
    <input type="text" name="new_Gender" class="inputt" >
    <!-- <br><br>
    <label for="new_grade">New Grade :</label>
    <input type="text" name="new_grade" class="inputt" > -->
    <br><br>
